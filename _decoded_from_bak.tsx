...
function InteractiveAccessoryNode({
   ...
   return (
      <div
         ...
         title={accessory.type === 'shelf' ? "1A" : accessory.type === 'hook_single' ? ".7'A �&A1/" : ".7'A �&�'(3"}
     ...
     <div className="flex flex-col md:flex-row gap-6 mt-4 w-full" style={{ minHeight: 460 }}>
          ...
          <div className="w-full h-full flex items-center justify-center overflow-auto min-h-0">
             ...
             {type === 'wall' && (targetObject as ShopBuilderWall).columns
                ...
                return (
                   ...
                   >
                      <div className="bg-white/90 px-1.5 py-0.5 rounded text-[9px] shadow-sm border border-stone-200">9�&��/</div>
                   </div>
                );
             })}
             {/* Draw Slats */}
       ...
       <div className="w-full md:w-[340px] md:max-w-[340px] flex-shrink-0 flex flex-col gap-4 overflow-y-auto pr-2 pb-4" style={{ maxHeight: 500 }}>
          ...
          <div className="flex bg-zinc-100 rounded-lg p-1">
             <button onClick={() => {setActiveSide('front'); setActiveId(null)}} className={`flex-1 py-2 text-sm font-bold rounded-md transition-all ${activeSide === 'front' ? 'bg-white shadow text-blue-600' : 'text-zinc-500 hover:text-zinc-700 hover:bg-zinc-200'}`}>'���,�! '�#�&'�&�`</button>
             <button onClick={() => {setActiveSide('back'); setActiveId(null)}} className={`flex-1 py-2 text-sm font-bold rounded-md transition-all ${activeSide === 'back' ? 'bg-white shadow text-blue-600' : 'text-zinc-500 hover:text-zinc-700 hover:bg-zinc-200'}`}>'���,�! '�.�A�`</button>
          </div>
           ...
           {!isAddingNewSystem ? (
             ...
             <div className="flex flex-col gap-4 p-4 bg-white rounded-xl border-2 border-blue-100 shadow-md relative overflow-hidden">
                ...
                <h3 className="font-bold text-zinc-800 text-sm mb-1 pb-2 border-b border-zinc-100">%6'A) � 8'�& ,/�`/</h3>
                
                {/* System Type Selector */}
                <div className="flex flex-col gap-1.5 flex-shrink-0">
                    <label className="text-xs font-bold text-zinc-600">1. � ��9 '�� 8'�&</label>
                    <select 
                    ...
                    >
                       <option value="slat">,/'1 41'&-�` (Slat Wall)</option>
                       <option value="supermarket_shelves">#1AA 3��(1 �&'1R* (Supermarket Shelves)</option>
                       <option value="primo">#9E/) (1JEH (Primo Stands)</option>
                    </select>
                </div>
               ...
               <div className="flex gap-2 flex-shrink-0 pt-2 border-t border-zinc-100">
                  <button
                     onClick={() => {
                       if (slatWalls.some(s => s.fillType === 'full' && s.side === activeSide)) return alert('�' �`�&R�  '�%6'A)�R �`��,/ � 8'�& �`4:� R'�&� '�,/'1 9��0 �!0' '���,�!.');
         ...
         {selectedSlat ? (
                    ...
                    return (
                        <div className="flex flex-col gap-4 p-4 border border-zinc-200 rounded-xl bg-white shadow-sm">
                           <div className="flex justify-between items-center pb-2 border-b border-zinc-100">
                             <h3 className="font-bold text-sm" style={{ color: primaryColor }}>%9/'/'* '�1A</h3>
                           ...
                           <div className="flex flex-col gap-1.5">
                              <label className="text-xs font-semibold text-zinc-600">'�����  '�#3'3�`</label>
                             ...
                             <div className="flex gap-2">
                               <div className="flex flex-col gap-1.5 flex-1">
                                  <label className="text-[10px] font-semibold text-zinc-500">'�916 (�&)</label>
                               ...
                               <div className="flex flex-col gap-1.5 flex-1">
                                  <label className="text-[10px] font-semibold text-zinc-500">'�9�&� (�&)</label>
            ...
            <div className="flex flex-col gap-4 p-4 border border-zinc-200 rounded-xl bg-white shadow-sm">
               <div className="flex justify-between items-center pb-2 border-b border-zinc-100">
                 <h3 className="font-bold text-sm" style={{ color: primaryColor }}>%9/'/'* '�� 8'�&</h3>
               ...
               {/* System Type */}
               <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-semibold text-zinc-600">� ��9 '�� 8'�&</label>
                  <select 
               ...
               {(!selectedSlat.systemType || selectedSlat.systemType === 'slat' || selectedSlat.systemType === 'primo') && (
                 /* Spacing */
                 <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-zinc-600">'��&3'A) (�`�  '�41'&- (�&)</label>
               ...
               {selectedSlat.systemType === 'supermarket_shelves' && (
                 <>
                   <div className="flex gap-2">
                     <div className="flex flex-col gap-1.5 flex-1">
                        <label className="text-[10px] font-semibold text-zinc-500">9// '�#1AA '�#A��`)</label>
                     ...
                     <div className="flex flex-col gap-1.5 flex-1">
                        <label className="text-[10px] font-semibold text-zinc-500">9�&� '�1A (�&)</label>
                   ...
                   <div className="flex flex-col gap-1.5">
                      <label className="text-xs font-semibold text-zinc-600">'��&3'A) (�`�  '�#9�&/) (�&)</label>
               ...
               {selectedSlat.systemType === 'primo' && (
                 <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-semibold text-zinc-600">'DE3'A) (JF 'D#9E/) (E)</label>
                    <input
                      type="number"
                      step="0.1"
                      min="0.4"
               ...
               {selectedSlat.fillType === 'partial' ? (
                  <>
                     <div className="flex gap-2">
                       ...
                       <div className="flex flex-col gap-1.5 flex-1">
                          <label className="text-[10px] font-semibold text-zinc-500">'�'1*A'9 (�&)</label>
                     ...
                     <div className="flex gap-2">
                       <div className="flex flex-col gap-1.5 flex-1">
                          <label className="text-[10px] font-semibold text-zinc-500">'��&��69 '�#A��` (0-1)</label>
                       ...
                       <div className="flex flex-col gap-1.5 flex-1">
                          <label className="text-[10px] font-semibold text-zinc-500">'�'1*A'9 �&�  '�#16 (�&)</label>
               ...
               {(!selectedSlat.systemType || selectedSlat.systemType === 'slat' || selectedSlat.systemType === 'primo') && (
                 <div className="pt-4 border-t border-zinc-100 flex flex-col gap-3">
                    <label className="text-xs font-semibold text-zinc-600">%6'A) '��&�-�'* (Accessories)</label>
                    <div className="grid grid-cols-3 gap-2">
                       <button onClick={() => {
                          ...
                          <div className="w-full aspect-square rounded-md bg-zinc-100 overflow-hidden relative">
                             <img src="https://static.commerceplatform.services/images/zoom/swws1224mp.rw_zoom.jpg" alt="1A .4(�`" className="w-full h-full object-cover mix-blend-darken" />
                          </div>
                          <span className="text-[10px] font-bold text-zinc-700">1A �&37-</span>
                       </button>
                       <button onClick={() => {
                          ...
                          <div className="w-full aspect-square rounded-md bg-zinc-100 overflow-hidden relative">
                             <img src="https://m.media-amazon.com/images/I/51H+WnKu2fL._AC_SX679_.jpg" alt="4��R *9��`�" className="w-full h-full object-cover mix-blend-multiply" />
                          </div>
                          <span className="text-[10px] font-bold text-zinc-700">4��R �&A1/</span>
                       </button>
                       <button onClick={() => {
                          ...
                          <div className="w-full aspect-square rounded-md bg-zinc-100 overflow-hidden relative">
                             <img src="https://s.alicdn.com/@sc04/kf/H3e06bf17449d413f8eebd8b07b989664K/Wholesale-Retail-Store-Metal-Waterfall-Display-Hook-with-Bins-Chrome-Finish-Slatwall-Compatible-Displays-for-Shop-Showcase.jpg_300x300.jpg" alt=".7'A �&�'(3" className="w-full h-full object-cover" />
                          </div>
                          <span className="text-[10px] font-bold text-zinc-700">.7'A �&�'(3</span>
                       </button>
                    </div>
                 </div>
               )}
...
const TEXTURE_OPTIONS = [
  { value: '', label: ''A*1'6�`', preview: null },
  {
      ...
      <header className="flex-shrink-0 h-14 bg-white/70 backdrop-blur-xl border-b border-zinc-200/50 px-6 flex items-center justify-between z-40 transition-all sticky top-0 mix-blend-luminosity">
        <div className="flex items-center gap-6">
          <div className="flex items-baseline gap-2 group cursor-default">
             ...
             <span className="font-bold text-lg tracking-tight text-zinc-900 group-hover:text-black transition-colors">{layout.shopName || '�&3'-) '�9�&�'}</span>
             <span className="text-xs font-medium text-zinc-400">/ {layout.field || '(/���  A&)'}</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-3 min-h-[60vh] lg:min-h-[calc(100vh-140px)] w-full max-w-[1920px] mx-auto">
          <div ref={floorplan2DRef} className={cn(
            ...
            <div className="flex items-center justify-between mb-3 p-3 pb-0">
              <div className="flex items-center gap-2">
                <h2 className="text-zinc-800 tracking-tight font-bold">�&O-1P�1 '��&.77 +� '&�` '�#(9'/</h2>
                {isDrawingMode && (
                  ...
                  <div className="bg-white rounded-xl shadow-2xl overflow-visible" style={{ border: `2px solid ${primaryColor}` }}>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 px-4 py-3 w-full sm:w-auto" dir="rtl">
                      ...
                      <div className="flex items-center gap-2 px-3 py-2 rounded-lg shadow-sm text-white" style={{ background: `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 100%)` }}>
                        <span className="text-sm font-bold">�x�� ,/'1</span>
                      </div>
                      ...
                      <div className="flex flex-col gap-1">
                        <label className="text-[10px] font-semibold" style={{ color: primaryColor }}>�x� '1*A'9 (�&)</label>
                        <input
                          type="number"
                          step="0.5"
                          min="0.5"
                      ...
                      {/* Thickness Control */}
                      <div className="flex flex-col gap-1">
                        <label className="text-[10px] font-semibold" style={{ color: primaryColor }}>�x� 3�&R (�&)</label>
                        <input
                          type="number"
                          step="0.05"
                          min="0.05"
                      ...
                      {/* Color Picker */}
                      <div className="flex flex-col gap-1">
                        <label className="text-[10px] font-semibold" style={{ color: primaryColor }}>�x}� ���� </label>
                        <input
                          type="color"
              ...
              return (
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 z-50 pointer-events-auto w-full max-w-4xl px-4">
                  <div className="bg-white rounded-xl shadow-2xl overflow-visible" style={{ border: `2px solid ${primaryColor}` }}>
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-3 px-4 py-3 w-full sm:w-auto" dir="rtl">
                      <div className="flex items-center gap-2 px-3 py-2 rounded-lg shadow-sm text-white" style={{ background: `linear-gradient(135deg, ${primaryColor} 0%, ${secondaryColor} 100%)` }}>
                        <span className="text-sm font-bold">�x: #� 8�&) '�916</span>
                      </div>

                      <div className="hidden sm:block h-8 w-px" style={{ backgroundColor: primaryColor }} />

                      <div className="flex flex-col gap-1">
                        <label className="text-[10px] font-semibold" style={{ color: primaryColor }}>'�� ��9</label>
                        <select
                          ...
                          style={{ border: `1px solid ${primaryColor}40` }}
                        >
                          <option value="full">R'�&� '�,/'1</option>
                          <option value="partial">�&3'-) ,2&�`)</option>
                        </select>
                      </div>
                      ...
                      {slatWall.fillType === 'partial' && (
                        <>
                          <div className="hidden sm:block h-8 w-px" style={{ backgroundColor: primaryColor }} />
                          <div className="flex flex-col gap-1">
                            <label className="text-[10px] font-semibold" style={{ color: primaryColor }}>'�916 (�&)</label>
                            <input
                          ...
                          <div className="hidden sm:block h-8 w-px" style={{ backgroundColor: primaryColor }} />
                          <div className="flex flex-col gap-1">
                            <label className="text-[10px] font-semibold" style={{ color: primaryColor }}>'��&��69 %</label>
                            <input
                      ...
                      <div className="hidden sm:block h-8 w-px" style={{ backgroundColor: primaryColor }} />
                      <div className="flex flex-col gap-1">
                        <label className="text-[10px] font-semibold" style={{ color: primaryColor }}>'�'1*A'9 (�&)</label>
                        <input
                      ...
                      <div className="hidden sm:block h-8 w-px" style={{ backgroundColor: primaryColor }} />
                      <div className="flex flex-col gap-1">
                        <label className="text-[10px] font-semibold" style={{ color: primaryColor }}>9�  '�#16 (�&)</label>
                        <input
                      ...
                      <div className="hidden sm:block h-8 w-px" style={{ backgroundColor: primaryColor }} />
                      <div className="flex flex-col gap-1">
                        <label className="text-[10px] font-semibold" style={{ color: primaryColor }}>'����� </label>
                        <input
                          type="color"
          ...
          <div ref={three3DRef} className="flex-1 rounded-2xl bg-white/90 backdrop-blur-lg shadow-sm border border-zinc-200/60 flex flex-col relative overflow-hidden group hover:border-zinc-300 transition-colors duration-500" data-three-container>
            <div className="flex items-center justify-between p-3 bg-white/80 backdrop-blur-sm border-b border-zinc-100 z-10">
              <h2 className="text-zinc-800 tracking-tight font-bold">�&9'�`� ) +�'+�`) '�#(9'/ *A'9��`)</h2>
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className="h-7 w-7 p-0 transition-all"
                  style={{ color: primaryColor }}
                  title={is3DFullscreen ? '.1��, �&�  �&�! '�4'4)' : '�&�! '�4'4)'}
                >
            ...
            <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 bg-white/90 backdrop-blur-xl border border-zinc-200/60 rounded-2xl shadow-2xl overflow-hidden hover:shadow-primary/5 transition-all">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 px-4 py-3 w-full sm:w-auto" dir="rtl">
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-white/50 backdrop-blur-md rounded-xl" style={{ border: `1px solid ${primaryColor}40`, color: primaryColor }}>
                  <span className="text-sm font-bold">�x� {product.name}</span>
                </div>
                ...
                <div className="flex flex-col gap-1 relative texture-dropdown">
                  <label className="text-[10px] font-semibold text-purple-600">�x� � 3�`,</label>
                  <button
                    type="button"
                  ...
                  >
                    {product.texture ? (
                      <>
                        ...
                        <span className="flex-1 text-left truncate">{TEXTURE_OPTIONS.find(t => t.value === product.texture)?.label || '� 3�`,'}</span>
                      </>
                    ) : (
                      <span className="flex-1 text-left">'A*1'6�`</span>
                    )}
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-[10px] font-semibold text-purple-600">
                    �x}� ����  {product.texture && <span className="text-[8px] opacity-70">(*#+�`1)</span>}
                  </label>
                  <input
                    type="color"
                    ...
                    title={product.texture ? '����  R*#+�`1 9��0 '�� 3�`,' : product.color || '#ffffff'}
                  />
                </div>
                  ...
                  <>
                    ...
                    <button
                      onClick={() => {
                        ...
                        if (confirm(`*7(�`� '�����  ��'�� 3�`, 9��0 ${similarProducts.length} �&� *, �&4'(�!�x`)) {
                      ...
                      title={`*7(�`� 9��0 ${similarCount} �&� *,'*`}
                    >
                      <span>�a�</span>
                      <span>*7(�`� ({similarCount})</span>
                    </button>
                  </>
                )}
              ...
              <div className="flex items-center justify-center gap-3 px-4 py-3 min-w-max" dir="rtl">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-5xl w-[95vw] h-[85vh] flex flex-col overflow-hidden bg-white/95 backdrop-blur-xl border border-zinc-200/60 shadow-2xl" dir="rtl">
                    <DialogHeader className="flex-none pb-4 border-b border-zinc-100">
                      <DialogTitle className="text-xl" style={{ color: primaryColor }}>�&/�`1 #� 8�&) '�916 (Display Systems)</DialogTitle>
                      <DialogDescription>
                        ��& (*��2�`9 '�41'&- 9��0 '�,/'1 (4R� -1. '3*./�& '��&9'�`� ) +� '&�`) '�#(9'/ (2D) �%6'A) ��*9/�`� '�41'&-.
                      </DialogDescription>
                    </DialogHeader>
                ...
                <div className="relative group/column">
                  ...
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 bg-white border border-zinc-200 rounded-xl shadow-xl opacity-0 invisible group-hover/column:opacity-100 group-hover/column:visible transition-all z-50 overflow-hidden flex flex-col">
                    ...
                    >
                      <Plus className="w-3.5 h-3.5" /> %6'A) 9�&��/ ,/�`/
                    </button>
                  </div>
                </div>
            ...
            <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 bg-white/90 backdrop-blur-xl border border-zinc-200/60 rounded-2xl shadow-2xl overflow-x-auto hover:shadow-primary/5 transition-all scrollbar-hide">
              <div className="flex items-center justify-center gap-3 px-4 py-3 min-w-max" dir="rtl">
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-white/50 backdrop-blur-md rounded-xl" style={{ border: `1px solid #d9770640`, color: "#d97706" }}>
                  <span className="text-sm font-bold">�x�: 9�&��/</span>
                </div>
                ...
                >
                  ...
                  <span>'���,�!: {(column.side || 'front') === 'front' ? '#�&'�&�`' : '.�A�`'}</span>
                </button>
...
const ShopBuilderProtected = () => {
  ...
  const routeState = (location.state || {}) as { fromIntro?: boolean; fromSetup?: boolean; adminBypass?: boolean };
  ...
  const canAdminBypass = isAdminAuthenticated || (isAuthenticated && isAdmin) || persistedAdminSession || !!routeState.adminBypass;

  useEffect(() => {
    if (loading) return;

    // Admin can access editor directly
    if (canAdminBypass) return;

    // Non-admin flow must start from intro first
    if (!routeState.fromIntro && !routeState.fromSetup) {
      navigate('/shop-builder/intro', { replace: true });
      return;
    }

    // Guests go to intro to avoid setup/editor bounce
    if (!isAuthenticated) {
      navigate('/shop-builder/intro', { replace: true });
      return;
    }

    // Logged-in non-admin without data -> setup
    if (!shopData) {
      navigate('/shop-setup', { replace: true });
      return;
    }
  }, [shopData, loading, navigate, isAuthenticated, canAdminBypass, routeState.fromIntro, routeState.fromSetup]);
