      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <ScrollAnimation animation="fadeIn" className="mb-6 md:mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link 
              to="/products" 
              className="hidden md:flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-slate-900 hover:bg-slate-800 rounded-xl transition-all duration-300 hover:shadow-xl hover:scale-105 group"
            >
              عرض الكل
