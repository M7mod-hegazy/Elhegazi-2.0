...
import { Star, ShoppingCart, Eye, Check, Plus, EyeOff } from 'lucide-react';
          ...
          <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100">
            ...
            <Link to={productPath} onClick={(e) => e.stopPropagation()} aria-label="عرض المنتج" className="block w-full h-full">
              <img
                ...
                alt={product.nameAr}
                className={`w-full h-full object-contain transition-all duration-700 ${imageLoaded ? 'opacity-100' : 'opacity-0'
