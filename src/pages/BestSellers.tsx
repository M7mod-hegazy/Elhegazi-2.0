...
import { ArrowRight, TrendingUp, Crown, Flame } from 'lucide-react';
            ...
            <div className="bg-white rounded-2xl shadow-lg border p-6 sticky top-8">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <Input
                    placeholder="ابحث في الأكثر مبيعاً..."
                    value={searchTerm}
              ...
              <div className="bg-gradient-to-r from-orange-100 to-red-100 rounded-xl p-4 border border-orange-200">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-semibold text-orange-600">الأكثر مبيعاً</span>
                </div>
                <p className="text-sm text-muted-foreground">
                  منتجات حققت أعلى مبيعات وحازت على ثقة عملائنا
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
              <div>
                <h2 className="text-2xl font-bold text-foreground mb-2">
                  الأكثر مبيعاً ({filteredProducts.length})
                </h2>
                <p className="text-muted-foreground">
                  المنتجات التي حققت أعلى مبيعات وأكثرها شعبية
                </p>
              </div>
